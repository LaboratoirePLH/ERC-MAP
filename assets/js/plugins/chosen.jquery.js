...
(function () {
  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.set_default_values = function () {
      ...
      this.normalize_query_text = this.options.normalize_query_text || function (query_text) {
        return query_text;
      };
    ...
    AbstractChosen.prototype.winnow_results = function () {
      var endpos, escapedQuery, fix, i, j, k, l, last_normalized_text, len, normalizedQuery, normalized_text, offset, option, prefix, query, ref, ref1, ref2, regex, results, results_group, search_match, startpos, substr_normalized_text, suffix, text;
      this.no_results_clear();
      results = 0;
      query = this.get_search_text();
      normalizedQuery = this.normalize_query_text(query);
