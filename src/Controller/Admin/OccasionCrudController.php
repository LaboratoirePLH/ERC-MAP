...
class OccasionCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setEntityLabelInPlural('Occasion')
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        $categorieOccasion = AssociationField::new('categorieOccasion');
        $id = IntegerField::new('id', 'ID');

        if (Crud::PAGE_INDEX === $pageName) {
            return [$id, $nomFr, $nomEn, $categorieOccasion];
        } elseif (Crud::PAGE_DETAIL === $pageName) {
            return [$id, $nomFr, $nomEn, $categorieOccasion];
        } elseif (Crud::PAGE_NEW === $pageName) {
            return [$nomFr, $nomEn, $categorieOccasion];
