...
abstract class AbstractEntity {
    ...
    protected function sanitizeWysiwygString($string): ?string
    {
        ...
        $string = strip_tags($string, '<strong><em><u><s><sub><sup><span><br>');
        ...
        // Replace fonts other than IFAOGreek by Arial
        $string = preg_replace('/"font-family:(?![\s]*ifaogreek)[^"]+"/i', '"font-family:Arial"', $string);
