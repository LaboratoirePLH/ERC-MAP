...
class QFonc
{
     ...
     * @ORM\SequenceGenerator(sequenceName="q_fonc_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     *
     * @ORM\ManyToMany(targetEntity="Localisation", inversedBy="idFonc")
     * @ORM\JoinTable(name="a_fonc",
     *   joinColumns={
     *     @ORM\JoinColumn(name="id_fonc", referencedColumnName="id")
     *   },
     *   inverseJoinColumns={
